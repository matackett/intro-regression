...
.pull-more-right[
.small-box-work[
$$\begin{aligned}\hat{\beta}_0 &= 63.877 - 0.519 \times 60.850 \\[10pt]
...
.alert[
Even if the intercept doesn't have a reasonable interpretation, we still need it in the regression equation so the line fits the data as closely as possible. 
]
